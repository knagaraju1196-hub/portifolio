              ...
              {education.map((edu, index) => (
                <div key={index} className="bg-gray-800 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                      <p className="text-gray-300"><strong>GPA:</strong> {edu.gpa}</p>
                      <p className="text-gray-300"><strong>Specialization:</strong> {edu.specialization}</p>
                    </div>
                  </div>
                  
                  <div>
                    <h6 className="font-semibold text-white mb-2">Highlights:</h6>
